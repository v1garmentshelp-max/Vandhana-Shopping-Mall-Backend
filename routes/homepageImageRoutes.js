  ...
  async (req, res) => {
    ...
    try {
        ...
        await pool.query(
          ...
          DO UPDATE SET
            page =
              COALESCE(
                EXCLUDED.page,
                homepage_images.page
              ),
            section =
              COALESCE(
                EXCLUDED.section,
                homepage_images.section
              ),
            slot_order =
              COALESCE(
                $4,
                homepage_images.slot_order
              ),
            default_image_url =
              COALESCE(
                EXCLUDED.default_image_url,
                homepage_images.default_image_url
              ),
            alt_text =
              COALESCE(
                EXCLUDED.alt_text,
                homepage_images.alt_text
              ),
            link =
              COALESCE(
                EXCLUDED.link,
                homepage_images.link
              ),
            extra_json =
              COALESCE(
                EXCLUDED.extra_json,
                homepage_images.extra_json
              ),
            updated_by =
              EXCLUDED.updated_by,
            updated_at =
      ...
      return res
        ...
        .json({
          message:
            'Failed to update homepage image metadata'
        })
    }
  }
)
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (
        ...
        await client.query(
          `
          INSERT INTO homepage_image_history (
            homepage_image_id,
            image_url,
            alt_text,
            link,
      ...
      return res
        ...
        .json({
          message:
            'Failed to replace homepage image'
        })
    } finally {
      client.release()
    }
    ...
    try {
      ...
      if (
        ...
        return res
          ...
          .json({
            message:
              'Previous image version not found'
          })
      }
      ...
      return res
        ...
        .json({
          message:
            'Failed to restore homepage image'
        })
    } finally {
      client.release()
    }
